...
(defun set-mark-and-goto-line-with-feedback ()
  "Show line numbers temporarily, while prompting for the line number input. set mark first."
  (interactive)
  "Show line numbers temporarily, while prompting for the line number input"
  (interactive)
  (unwind-protect
...
(defun rotate-windows ()
  "Rotate your windows (e.g. swap left/right)"
  (interactive)
  (cond ((not (> (count-windows)1))
         (message "You can't rotate a single window!"))
        (t
